...
def test_pytest_parallel_threads(mock_client_init):
    ...
    expect(finish_args[0][1]['status'] == 'PASSED', 'Launch failed')
    launch_end_time = finish_args[0][1]['end_time']
    expect(launch_end_time is not None and launch_end_time > 0,
